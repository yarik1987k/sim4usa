...
function library_block() {
	$labels = array(
		'name'                  => __( 'Block Library', 'defaultTheme' ),
		'singular_name'         => __( 'Library Block', 'defaultTheme' ),
		'menu_name'             => __( 'Block Library', 'defaultTheme' ),
		'name_admin_bar'        => __( 'Block Library', 'defaultTheme' ),
		'add_new'               => __( 'Add New', 'defaultTheme' ),
		'add_new_item'          => __( 'Add New Library Block', 'defaultTheme' ),
		'new_item'              => __( 'New Library Block', 'defaultTheme' ),
		'edit_item'             => __( 'Edit Library Block', 'defaultTheme' ),
		'view_item'             => __( 'View Library Block', 'defaultTheme' ),
		'all_items'             => __( 'All Library Blocks', 'defaultTheme' ),
		'search_items'          => __( 'Search Block Library', 'defaultTheme' ),
		'parent_item_colon'     => __( 'Parent Block Library:', 'defaultTheme' ),
		'not_found'             => __( 'No library blocks found.', 'defaultTheme' ),
		'not_found_in_trash'    => __( 'No library blocks found in Trash.', 'defaultTheme' ),
		'featured_image'        => __( 'Library Block Cover Image', 'defaultTheme' ),
		'archives'              => __( 'Block library archives', 'defaultTheme' ),
		'insert_into_item'      => __( 'Insert into library block', 'defaultTheme' ),
		'uploaded_to_this_item' => __( 'Uploaded to this library block', 'defaultTheme' ),
		'filter_items_list'     => __( 'Filter block library list', 'defaultTheme' ),
		'items_list_navigation' => __( 'Block library list navigation', 'defaultTheme' ),
		'items_list'            => __( 'Block library list', 'defaultTheme' ),
	);

	register_post_type(
		'library_block',
		array(
			'label'               => __( 'Block Library', 'defaultTheme' ),
			'labels'              => $labels,
